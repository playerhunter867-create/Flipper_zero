...
public class IRManager {
    ...
    // ====== ТВ TOSHIBA (работает на твоём телевизоре!) ======
    public void sendToshibaPower() {
        sendSignal(38000, new int[]{3800, 1900, 480, 1350, 480, 1350, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 480});
    }

    public void sendToshibaVolUp() {
        sendSignal(38000, new int[]{3800, 1900, 480, 1350, 480, 1350, 480, 480, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 480});
    }

    public void sendToshibaVolDown() {
        sendSignal(38000, new int[]{3800, 1900, 480, 1350, 480, 1350, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 480, 480, 1350, 480, 480, 480, 1350, 480, 480, 480, 480, 480, 480, 480, 1350, 480, 480});
    }
